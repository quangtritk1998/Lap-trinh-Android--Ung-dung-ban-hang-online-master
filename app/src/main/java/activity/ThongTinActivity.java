...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(uit).title("Trường Đại học Công nghệ Thông tin TPHCM").snippet("Khu phố 6, P.Linh Trung, Q.Thủ Đức, TP.Hồ Chí Minh.").icon(BitmapDescriptorFactory.defaultMarker()));
